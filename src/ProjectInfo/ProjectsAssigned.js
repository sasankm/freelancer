...
class ProjectsAssigned extends React.Component {
    constructor(props) {
        super(props);
        this.state = {}
    ...
    render() {
        ...
        hiredEle = <div class="container">
            <div class="col-sm-6">
                <label><h3>Projects Assigned To Me :</h3></label>
                <h2>weserve</h2>
                <div class="well well-lg">
                    <h4><u>Project Description:</u></h4>
                    <p>similar to freelancer</p>
            ...
            <div class="well well-lg col-sm-4">
                <form onSubmit={this.handleSubmit}>
                    <div class="form-group">
                        <label for="bid"><u>Upload File Here :</u></label>
                        <input type='file' OnChange={this.handleChange} name="file" id="file"/>
                    </div>
                    <div class="form-group">
                        <label for="period"><u>Comment :</u></label><br />
                        <textarea  OnChange={this.handleChange} name="money" class="form-control"/>

                    </div>
                    <button type="submit" class="center-block btn btn-primary">Submit Project</button>
                </form>
            </div>
        </div>
...
const ConnectedProjectsAssignedPage = connect(mapStateToProps, mapDispatchToProps)(ProjectsAssigned);
export default ConnectedProjectsAssignedPage;